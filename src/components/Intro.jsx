...
export function Intro() {
  return (
    <>
      ...
      <h1 className="mt-10 font-display text-3xl/tight font-light text-white">
      Education. Anytime. Anywhere{' '}
        <span className="text-sky-300">"Elevate Education, Enhance Skills"</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300 tracking-wide">
      Welcome to <span className='text-sky-300 uppercase'>Study Stream</span>, your gateway to knowledge and growth. Our platform offers a wide range of courses and personalized learning experiences to help you master new skills. Learn anytime, anywhere, and take your education to the next level!
      </p>
      <SignUpForm />
